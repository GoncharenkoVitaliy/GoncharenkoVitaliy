...
#### В частности Frontend разработка привлекла на начальном этапе — относительно быстрым стартом в IT, а затем увлекла творческой работой и тем что необходимо узнавать что-то новое и расширять свой набор навыков, постоянное развитие.
